...
const FloatingInput = forwardRef((props, ref) => {
  ...
  return (
    <div style={{ marginBottom: "2px", margin: props.margin }}>
      <Container
      ...
      >
        ...
        />
        <Label
          filled={valueState !== 0 ? !!valueState : true}
          fontSize={props.fontSize || props.style?.fontSize || "1rem"}
          error={props.error}
          style={props.labelStyle}
        >
          {props.label || props.placeholder} {props.required && <sup>*</sup>}
        </Label>
      </Container>
      ...
      {props.error && props.helperText && (
        <Error>
          ...
          <span style={{ marginLeft: "2px" }}>{props.helperText}</span>
        </Error>
      )}
    </div>
  );
