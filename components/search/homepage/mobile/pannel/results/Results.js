                ...
                <Result key={i}title={props.results[i]["_source"].name} type={type} cta={cta} onclick={null}></Result> 
                    ...
                    if(props.filters['locations'] || props.filters['all'])
                        LocationResultsArr.push(
                            <CityResult parent={props.results[i]["_source"].parent} id={props.results[i]["_source"].resource_id} key={i} title={props.results[i]["_source"].name} type={type} cta={cta} onclick={null}></CityResult> 
