        ...
        <div>
          ...
          >
            ...
            !props.is_registration_needed ? (
              <StyledEditIcon
                onClick={() =>
                  props.setShowPoiModal({
                    name: props.poi_name,
                    city_id: props.city_id,
                    day_slab_index: props.day_slab_index,
                    slab_element_index: props.slab_element_index,
          ...
          {props.meta ? (
            <Notes
              blur={props.blur}
              meta={props.meta}
              transfer={props.element_type === ITINERARY_ELEMENT_TYPES.transfer}
            ></Notes>
          ) : null}
          {props.is_poi_rec ? <Poi text={props.text}></Poi> : null}
          {props.activity_data ? (
            props.activity_data.poi ? (
                  ...
                  >
                    ...
                    <ul>
                      <li style={{ fontWeight: "200" }}>
                        {props.activity_data.poi.tips[0]}
                      </li>
                      {props.activity_data.poi.tips.length > 1 ? (
                        <li style={{ fontWeight: "200" }}>
                          {props.activity_data.poi.tips[1]}
                        </li>
                      ) : null}
                    </ul>
                  </div>
