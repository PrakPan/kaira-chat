    ...
    <div className="flex flex-col items-center gap-5">
      <div className="flex flex-col items-center gap-3">
        <div className="relative text-[30px] md:text-[40px] font-bold">
          <Image
            src={`https://d31aoa0ehgvjdi.cloudfront.net/media/new-year/tree.png`}
            width={60}
            height={60}
        ...
        <SecondaryHeading>
          Choose us for unforgettable experiences, expert guidance, and a
          commitment to making your journey memorable.
        </SecondaryHeading>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {WHY_CHOOSE_US.map((item, index) => (
          ...
          >
            <Image
              src={`https://d31aoa0ehgvjdi.cloudfront.net/${item.icon}`}
              width={45}
              height={45}
            />
