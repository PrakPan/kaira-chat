...
const _openAllNotificationsHandler = () => {
  ...
  axiosnotificationsinstance.patch("", {},  {headers: {
    ...
    return(
      <div>
      <div className='hidden-desktop'><NewMobile _openAllNotificationsHandler={_openAllNotificationsHandler} _deleteNotificationHandler={_deleteNotificationHandler} notifications={notifications} _deleteNotificationHandler={_deleteNotificationHandler} headerColor={headerColor} hideNav={hideNav} notOpenCount={notOpenCount} ></NewMobile></div>
      <div   className='hidden-mobile'>
        <div style={{display: hideNav? 'none !important' : 'initial !important'}}>
          <IndexDesktop ctaonclick={props.ctaonclick} hidehomecta={props.hidehomecta} hidecta={props.hidecta} _deleteNotificationHandler={_deleteNotificationHandler} _openAllNotificationsHandler={_openAllNotificationsHandler} notOpenCount={notOpenCount} notifications={notifications} token={props.token} headerColor={headerColor} style={{}}></IndexDesktop>
        </div> 
      </div>
      </div>
    );
