                  ...
                  multiCitySuggestions.map((sugg, idx) => (
                    <div key={sugg?.result_index ?? idx} className="w-full">
                      {sugg?.data?.duration?.text && (
                        <div className="px-1 pb-1 ttw-type-body-strong text-[#445069] flex items-center gap-2">
                          <span>{sugg.name}</span>
                          <span className="ttw-type-small text-[#8a93a6] bg-[#f4f3ec] rounded px-2 py-0.5">
                            {sugg.data.duration.text}
                          </span>
                        </div>
                      )}
      ...
      {showWarningModal &&
        ReactDOM.createPortal(
          <div className="fixed z-[1666] inset-0 bg-black bg-opacity-50 flex items-end md:items-center justify-center">
            <div className="bg-[#fafaf5] w-full max-w-lg md:mx-4 mb-0 md:mb-auto md:rounded-lg rounded-t-2xl md:rounded-b-lg relative transform transition-transform duration-300 ease-out animate-slide-up md:animate-none max-h-[90vh] md:max-h-none overflow-hidden">
              ...
              {!isProcessingBooking && (
                <button
                  ...
                  className="absolute top-4 right-4 md:top-4 md:right-4 p-2 text-[#445069] hover:text-[#0b1220] cursor-pointer z-10"
                >
                  <FaX size={16} />
                </button>
              )}
              ...
              <div className="px-6 pb-6 pt-2 md:pt-6 max-h-[calc(90vh-8rem)] md:max-h-none overflow-y-auto">
                ...
                <div className="text-[#445069] mb-6">
                ...
                <div className="flex flex-col-reverse md:flex-row gap-3 md:gap-4 justify-end border-t-2 pt-4">
                  <button
                    ...
                    className="w-full md:w-auto px-6 py-2 md:py-2 ttw-type-body text-[#445069] border border-[#ececec] rounded-xl hover:bg-[#f4f3ec] transition-colors cursor-pointer text-center disabled:opacity-50"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="w-full md:w-auto px-6 py-2 md:py-2 ttw-type-body bg-[#0b1220] text-white rounded-xl hover:bg-[#1a2436] transition-colors cursor-pointer text-center disabled:opacity-50"
                  >
...
const RoundTripSuggestion = ({
 ...
 selectedTripType === "roundtrip" ? "border-[#f7e700] bg-[#fffde7]" : ""
 }`}
    >
      {isDesktop && (
        <div
      ...
      <div className="w-full flex flex-col gap-3">
        <div className="flex flex-row gap-2">
          {!isDesktop && (
            <div
              className={`w-[60px] h-[60px] px-2 bg-[#f4f3ec] rounded-xl flex items-center justify-center`}
            >
              <TransfersIcon
                TransportMode={"Taxi"}
                Instyle={{
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-row items-center gap-2">
            ...
            {selectError && (
              <div className="bg-[#CD2026] ttw-type-small md:ttw-type-body lg:ttw-type-body text-white py-1 px-2 rounded-lg text-center animate-popOut">
...
const MultiCityTripSuggestion = ({
  ...
  return (
    <div
      className={`w-full flex flex-row gap-2 items-start rounded-2xl py-3 px-3 pl-2 shadow-sm border-x-2 border-t-2 border-b-4 ${
 selectedTripType === "multicity" ? "border-[#f7e700] bg-[#fffde7]" : ""
 }`}
    >
      {isDesktop && (
        <div
