...
const HeadingContent = ({ title, subtitle }) => {
  ...
  useGSAP(() => {
    ...
    .to(buttonRef.current, {
      ...
      duration: 1,
      ease: "power2.out"
    }, "+=0.2"); // Start 0.2 seconds after content wrapper animation
  ...
  return (
    <div ref={containerRef} className={styles.headingContent}>
      ...
      <button ref={buttonRef} className="bg-slate-800 no-underline group cursor-pointer relative rounded-full p-px text-xs font-semibold leading-6 text-white inline-block mt-6">
