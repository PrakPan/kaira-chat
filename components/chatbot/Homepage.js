...
import tailored from '../../services/leads/tailored';
const ExperienceChat = (props) => {
  ...
  const _sendAnswersHandler = ( ) => {
    ...
    const steps=[
        ...
        {
          id: '2',
          message: 'Hey There! Welcome to your one-stop solution to everything travel. How may I assist you today?',
        ...
        },
        {
          ...
          options: [
            ...
            { value: 1, label: ' I want to book a travel experience', trigger: 'book-experience-options' },
            { value: 2, label: ' I want to personalize a travel experience', trigger: 'book-experience-personalise' },
            { value: 3, label: 'I want to get in touch with a travel expert', trigger: 'book-experience-personalise-name' },
        ...
        },
        {
        ...
        },
         {
          ...
          options: [
            { value: 1, label: 'I want to personalize an experience', trigger: 'book-experience-personalise' },
            { value: 2, label: 'I have a few additional questions about booking', trigger: 'book-experience-personalise-name' },
          ],
         ...
         trigger: 'book-experience-personalise-waiting-locationselect',
          ...
          options: [
            {value: 1, label: 'Yes', trigger: 'book-experience-personalise-locationenter'},
            {value: 2, label: 'No', trigger: 'book-experience-personalise-budget'}
          ]
        },
        {
          ...
          options: [
            {value: 1, label: 'Affordable', trigger: () => {answers = {...answers, budget: 'Affordable'}; return('book-experience-personalise-duration');}},
            {value: 2, label: 'Average',  trigger: () => {answers ={...answers, budget: 'Average'}; return('book-experience-personalise-duration');}},
            {value: 3, label: 'Luxury', trigger: () => {answers = {...answers, budget: 'Luxury'}; return('book-experience-personalise-duration');}},
          ]
        },{
        ...
        },
        {
          ...
          options: [
            {value: 1, label: 'Less Than a Week', trigger: () => {answers ={...answers, duration: "Less Than a Week"}; return('book-experience-personalise-message');}},
            {value: 2, label: '7 - 14 Days',  trigger: () => {answers ={...answers, duration: "7 - 14 Days"}; return('book-experience-personalise-message');}},
            {value: 3, label: 'More than 14 Days', trigger: () => {answers ={...answers, duration: "More than 14 Days"}; return('book-experience-personalise-message');}},
          ]
        },
        {
        ...
        },
        {
            ...
            trigger: (value) => {answers ={...answers, message: value.value}; return('book-experience-personalise-name');},
            user: true,
        },
        {
        ...
        
        {
            ...
            user: true,
            trigger: (value) => { answers ={...answers,  name: value.value}; return('book-experience-personalise-mobile');},
        },
        {
        ...
        },
         {
            ...
            user: true,
            trigger: (value) => { answers ={...answers, phone: value.value}; return('book-experience-personalise-email');},
        },
        {
        ...
        },
         {
            ...
            user: true,
            trigger: (value) => { answers ={...answers,email: value.value}; _sendAnswersHandler(); return('book-experience-personalise-complete');},
        },
        {
            id: 'book-experience-personalise-complete',
            message: 'Thank you for getting in touch! An experience captain will reach out to you within 12 hours.',
            trigger: () => { return('more-help');} ,
        },
        {
        ...
        },
        {
            ...
            user: true,
            trigger: (value) => { answers ={...answers, locations: value.value}; return('book-experience-personalise-budget'); }
        },
        {
