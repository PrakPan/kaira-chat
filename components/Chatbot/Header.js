...
React.useEffect(() => {
  const handleClickOutside = (event) => {
    if (hoveredIcon && !event.target.closest('.icon-button-wrapper')) {
      setHoveredIcon(null);
    }
  };
  ...
  <IconButton
    ...
    onMouseEnter={() => isDesktop && setHoveredIcon("new")}
    onMouseLeave={() => isDesktop && setHoveredIcon(null)}
  >
              <svg
  ...
  <IconButton
    ...
    onMouseEnter={() => isDesktop && setHoveredIcon("history")}
    onMouseLeave={() => isDesktop && setHoveredIcon(null)}
  >
