...
const Experiences= (props) => {
    ...
    return(
      <Container onClick={props.onclick ? props.onclick : null} >  
          <BackroundImageLoader filter="linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.6))"   padding="0" zoomonhover center dimensions={{width: 900, height: 900}} height={isPageWide ? "30vh" : '60vh'} filters="linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))"  url={props.img}>
