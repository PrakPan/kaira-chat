            ...
            <ImageCard onClick={() => _handleRedirect("Caravans")}>
              ...
              <ImageFade>
                <LazyImageLoader
                  fit="cover"
                  dimensions={{
                    width: Math.round(props.width / 2),
                    height: Math.round(props.height / 2),
                  }}
                  dimensionsMobile={{
                    width: Math.round(props.width / 2),
                    height: Math.round(props.height / 2),
                  }}
                  url="media/website/KT9A9994.jpg"
                />
              </ImageFade>
            </ImageCard>
          </Card>
          ...
          <ImageCard onClick={() => _handleRedirect("Faces Of India")}>
            ...
            <ImageFade>
              <LazyImageLoader
                ...
                url="media/website/IMG_20180530_220624.jpg"
              />
            </ImageFade>
          </ImageCard>
        </Card>
          ...
          <ImageCard onClick={() => _handleRedirect("Volunteer & Travel")}>
            ...
            <ImageFade>
              <LazyImageLoader
                ...
                url="media/website/Volunteering.jpg"
              />
            </ImageFade>
          </ImageCard>
        </Card>
          ...
          <ImageCard onClick={() => _handleRedirect("Travel & Learn")}>
            ...
            <ImageFade>
              <LazyImageLoader
                ...
                url="media/website/yoga ose-1.jpg"
              />
            </ImageFade>
          </ImageCard>
        </Card>
