...
//
// Moved to ./transportIcons so the V1 archive's transfers list can render the
// same icons without importing this module. Re-exported here because these
// names were already part of this file's surface.
// Imported (not just re-exported) because this module uses them itself — a
// bare `export ... from` would not bind the names in local scope.
export { TRANSPORT_ICONS, TRANSPORT_BADGE_STYLES, getTransportBadgeStyle };
