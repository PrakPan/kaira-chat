    ...
    <>
      ...
      <CartSheet
        ...
        onPay={(payType?: string) => {
          ...
          // Which sale the tap asked for. The sheet's hold card offers both a
          // hold and paying in full, so the drawer can no longer infer it from
          // the cart; the footer bar omits it and the drawer keeps its own
          // `payNowType`.
