...
const ImageLoader = (props) => {
  ...
  return (
    ...
    >
      ...
      <SmallImage
        src={!is_url ? `${imgUrlEndPoint}/${btoa(smallImageRequest)}` : props.url}
        style={{
        ...
        ></SmallImage>
      <FullImage
        src={!is_url ? error ? 'https://d31aoa0ehgvjdi.cloudfront.net/media/website/grey.png': `${imgUrlEndPoint}/${btoa(imageRequest)}` :props.url}
