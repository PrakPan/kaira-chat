  ...
  return(
      ...
      <TabPanel value={value} index={0} >
       ...
       <TabPanel value={value} index={3} >
            {/* <Recommendations recommendations={props.recommendations} tips={props.tips}/> */}
      <Policies data={props.data}></Policies>
       ...
       <TabPanel value={value} index={4} >
            ...
            {props.data.description ? <div className='font-opensans'>{props.data.description}</div> : null}
       </TabPanel>
