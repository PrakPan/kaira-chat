...
const HotelBookingDetails = (props) => {
  ...
  const viewAllGalleryLink = hotelImages && hotelImages.length && ImagesLoaded[0] ? (
    ...
    >
      <span onClick={() => {props?._setImagesHandler(images);}} className="ttw-type-small font-600 border-solid border-b-sm border-text-white text-white cursor-pointer"> Show all photos</span>
    </div>
  ) : null;
          ...
          {loadingDetails ? (
            ...
            <div>
              {data?.star_category && data?.star_category!="0" ?
                <>
                  <span className="ttw-type-small bg-[#f4f3ec] text-[#445069] border border-[#ececec] px-2 py-0.5 rounded-full mb-md inline-block">
              ...
              <div className="flex gap-sm mt-sm">
                ...
                {data?.rating && (
                  <div className="gap-1 flex flex-row  items-center ttw-type-small text-[#445069] pl-sm border-l-sm border-solid border-[#ececec]">
              ...
              <div className="overflow-y-scroll pb-24" ref={scrollableTabRef} style={{ height: `calc(100vh - 170px)` }}>
                        ...
                        <GridImage>
                          <Child area="5 / 7 / 1 / 1" className="div1 ">
                            ...
                            >
                              ...
                              {images[0]?.caption ? (
                                <div className="bg-black/55 text-white backdrop-blur ttw-type-small px-md py-xs rounded-xl absolute top-md left-md">
                                  {images[0]?.caption}
                                </div>
                              ) : null}
                            </div>
                ...
                <div className="flex flex-col">
                  <div ref={stickyTabsRef} className="sticky top-0 z-10 bg-white border-b-sm border-solid border-[#ececec]">
                    <ScrollableMenuTabs
                      classStyle="w-100"
                      items={items}
                  ...
                  <div>
                    <div id="section-1">
                      {data?.hotel_details?.description ? (
                        <div className="flex flex-col gap-1">
                          <div
                            className="ttw-type-small gl-dynamic-render-elements text-[#445069]"
                      ...
                      <DetailsContainer>
                        {data?.hotel_details?.check_in?.date &&
                          ...
                          <div className="flex justify-between w-[80%] max-ph:w-full max-ph:flex-col max-ph:gap-3 mt-lg">
                            <div>
                              <div className="ttw-type-body font-600 mb-xxs-md text-[#0b1220]">Check In</div>

                              <div className="ttw-type-small text-[#445069]"> {dateFormat(data?.hotel_details?.check_in.date)}
                            ...
                            <div>
                              <div className="ttw-type-body font-600 mb-xxs-md text-[#0b1220]">Check Out </div>
                            ...
                            <div>
                              <div className="ttw-type-body font-600 mb-xxs-md text-[#0b1220]">Guests </div>
                              <div className="ttw-type-small text-[#445069]">
                      ...
                      {data?.hotel_details?.check_in?.instructions?.length > 0 &&
                        <>
                          <div className="mt-lg">
                            <div className="ttw-type-body font-600 mb-xxs-md text-[#0b1220]">Check In Instructions</div>
                            <div className="flex flex-col gap-1">
                      ...
                      {data?.hotel_details?.facilities?.length > 0 && <>
                        <div>
                          ...
                          <div className="ttw-type-body font-600 mb-lg text-[#0b1220]">Hotel Amenities</div>
                          <ul className="grid grid-cols-3 max-ph:grid-cols-2 gap-y-2 gap-x-4 !pl-md">
                            {activeFacilities.length > 0 && activeFacilities.map((item, index) => (
                              <>
                                <li className="ttw-type-small list-disc text-[#445069]" key={index}>
                                  {item}
                                </li>
                              </>
                            ))}
                          </ul>
                          {!viewMoreFacilites && <div className="ttw-type-small font-500 underline cursor-pointer text-[#0b1220]" onClick={() => calculateVisibleFacilites(data?.hotel_details?.facilities || [], true)}> + {data?.hotel_details?.facilities?.length - activeFacilities?.length}  more</div>}
                    ...
                    <div id="section-2">
                      ...
                      {data?.hotel_details?.rates && (
                        <>
                          <div className="ttw-type-body font-600 mb-lg text-[#0b1220]">Selected Rooms</div>
                          <Rooms
                    ...
                    <div id="section-3">
                      ...
                      {data?.rating > 0 && (
                        <div>
                          <div className="ttw-type-body font-600 mb-lg text-[#0b1220]">Reviews</div>
                          <div className="grid grid-cols-3 max-ph:grid-cols-1 gap-y-2 gap-x-4">
                            <div className="flex flex-row gap-sm-md">
                              <div className="ttw-type-h2 font-700 text-[#0b1220]"> {data?.rating}</div>
                              <div>
                                {data?.rating && (
                                  <div className="gap-1 flex flex-column ttw-type-small text-[#445069]">
                                    <div className="flex flex-row text-[#f7e700]">
                                      {starRating(data?.rating)}
                                    </div>
                                    {data?.hotel_details?.user_ratings_total > 0 || data?.user_ratings_total > 0 && (
                            ...
                            <div>
                              ...
                              {data?.hotel_details?.category_ratings && data?.hotel_details?.category_ratings?.length > 0 && <>
                                <div className="ttw-type-body font-600 mb-sm-md text-[#0b1220]">Rating Categories</div>
                                      ...
                                      (item, index) => (
                                        <tr>
                                          {item?.category != "recommendation_percent" && (
                                            <>
                                              <td className="ttw-type-small text-[#445069]">
                                              ...
                                              <td className="flex items-center gap-1 ">
                                                ...
                                                <span className="ttw-type-small text-[#445069]"> {item?.rating} </span>
                                              </td>
                                            </>
                                          )}
                                        </tr>
                    ...
                    <div id="section-4" className="mb-lg">
                      {data?.hotel_details?.google_maps_link ? (
                        <div>
                          <div className="ttw-type-body font-600 mb-lg text-[#0b1220]">Location</div>
                          <div className="flex gap-2">
                            <div>
                              {svgIcons.loaction}
                            </div>
                            <div className="ttw-type-small text-[#445069] mb-sm">
                              {[
