   ...
   return(
      <Container className='border-thin'>
            ...
            <ImageLoader  fit="contain" url={props.images.length ? image: 'media/icons/bookings/notfounds/noroom.png'} dimensions={{width: 900, height: 900}} dimensionsMobile={{width: 600, height: 600}} width="20vh" height={isPageWide ? '20vh' : "41vw" } widthmobile="41vw"  margin="auto"/> 
                           <Name className='font-lexend'>{props.data.room_type}</Name>
            ...
            <ContentContainer style={{display: 'flex', flexDirection: 'column'}}>
                ...
                {ammenities  ? ammenities.length ? ( ammenities.length > 5 && !isPageWide ) || ( ammenities.length > 20 && isPageWide ) ?  <p style={{fontSize: '0.75rem', marginLeft: '3px', marginTop: '0.5rem', textDecoration: 'underline' , color:  'rgba(91, 89, 89, 1)'}} className="font-lexend">View All</p> : null : null : null}
                </div>
    ...
    <NoImageContainer className='border-thin'>
                 ...
                 <Name style={{textAlign: 'left'}} className='font-lexend'>{props.data.room_type}</Name>
                 <AmenitiesContainer>
                    {ammenities}            
                </AmenitiesContainer>
      </NoImageContainer>
