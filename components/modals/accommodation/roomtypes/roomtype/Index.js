  ...
  if (true)
    return (
      <Container className="">
        ...
        {/* <div
          style={{
            padding: !isPageWide ? '2vw' : '1vw',
            width: isPageWide ? '25vh' : 'max-cotent',
          }}
        >
          <ImageLoader
            fit="contain"
        ...
        <ContentContainer style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          {/* <div>
            <AmenitiesContainer>
              {ammenities
                ? ammenities.length
                  ? !isPageWide
                    ? ammenities.length > 5
                      ? ammenities.splice(0, 4)
                      : ammenities
                    : ammenities.length > 20
                    ? ammenities.splice(0, 19)
                    : ammenities
                  : null
                : null}
            </AmenitiesContainer>
            {ammenities ? (
              ammenities.length ? (
                (ammenities.length > 5 && !isPageWide) ||
                (ammenities.length > 20 && isPageWide) ? (
                  <p
                    style={{
                      fontSize: '0.75rem',
                      marginLeft: '3px',
