    ...
    useEffect(() => {
      ...
      return(
        <div  className='center-div' interval={ props.hover ?  1000 : null } wrap={false} slide={false} fade activeIndex={index} onSelect={handleSelect}>
            {/* {imagesJSX} */}
            <ImageLoader borderRadius="50%" url={props.images.length ? props.images[0].image : ''}   width='12.5vw' widthmobile="100%" height="auto"   dimensions={{width: 800, height: 800}} dimensionsMobile={{width: 1800, height: 1200}}></ImageLoader>
