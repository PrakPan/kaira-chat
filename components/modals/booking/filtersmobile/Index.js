...
export default function TemporaryDrawer(props) {
 ...
 const _closePannel = () => {
  ...
  return (
   ...
   id="filter-tab" 
  >
            <Tab  id="filter-budget" key="filter-budget" label={"Budget"} className={"booking-filter-tab font-lexend"}></Tab>
            <Tab  id="filter-type" key="filter-type" label={"Type"} className={"booking-filter-tab font-lexend"}></Tab>
