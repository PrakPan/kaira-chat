    ...
    <div style={{display: 'grid', gridTemplateColumns: 'max-content auto',  gridGap: '0.5rem',  marginBottom: '0.75rem', marginTop: '0.75rem'}}>
        ...
        <div style={{display: 'grid',  gridGap: '1rem', gridTemplateColumns: '1fr 1fr', marginBottom: '0.75rem', marginTop: '0.75rem'}}>
                    ...
                    <ImageLoader url="media/icons/bookings/time.svg" height="1.5rem" width="1.5rem" widthmobile="1.5rem" dimensions={{width: 100, height: 100}} margin="0" leftalign></ImageLoader>
                            <div>
                            <IconHeading className='font-lexend'>{props.selectedBooking.costings_breakdown ? props.selectedBooking.costings_breakdown.duration ? props.selectedBooking.costings_breakdown.duration.text :null  : null}</IconHeading>
                            <Text  className='font-nunito'>Included</Text>
                            </div>
                        </div> : null}
                </div>
                <div style={{display: 'flex',  gap: '0.5rem', marginBottom: '0.75rem'}}>
                    ...
                    <div style={{display: 'flex', gap: '1rem'}}> 
                        <div className='centerdiv'>
                            <IconHeading className='font-lexend'>{props.selectedBooking.costings_breakdown ? props.selectedBooking.costings_breakdown.distance ? props.selectedBooking.costings_breakdown.distance.text :null  : null}</IconHeading>
                            <Text   className='font-nunito'>Included</Text>
                        </div>
