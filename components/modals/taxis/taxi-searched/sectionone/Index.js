    ...
    return(
      <Container className='font-lexend'>  
            ...
            <div className="center-dv" style={{ padding: '0.75rem 0.5rem', borderColor: 'rgba(238, 238, 238, 1)', borderWidth: '1px', borderStyle: 'none solid none none'}}>
              ...
              <p style={{margin: '0.5rem 0rem 0rem 0rem', fontSize: '15px', fontWeight: '700'}} className="font-lexend text-center">{props.data.taxi_type}</p>
              <p style={{margin: '0 0rem 0.25rem 0rem', fontSize: '13px', fontWeight: '300'}} className="font-lexend text-center">{props.data.no_of_seats + "-seater"}</p>
