        ...
        <div className="pt-2">
            ...
            <div className="ttw-detail-card rounded-2xl overflow-hidden">
              ...
              <div className="px-4 py-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="flex-1 border-t border-dashed border-[#e2e0d6]" />
              ...
              <div className="grid grid-cols-2 max-ph:grid-cols-1 gap-px bg-[#efede6] border-t border-[#efede6]">
                {[0, 1].map((i) => (
          ...
          <div>
            ...
            <div className="ttw-detail-card rounded-2xl overflow-hidden">
              ...
              <div className="border-b border-[#efede6] px-4 py-4 flex justify-center">
                <Line className="w-full max-w-[220px] h-[120px] rounded-xl" />
              </div>
              <div className="grid grid-cols-2 max-ph:grid-cols-1 gap-px bg-[#efede6]">
                {[0, 1, 2, 3].map((i) => (
                  <div key={i} className="bg-white px-4 py-3">
                    <Line className="w-16 h-3 mb-1.5" />
