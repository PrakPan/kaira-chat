...
const Gallery = (props) => {
  ...
  return(
      <Container className=''>
        ...
        {false ? <ImageLoader borderRadius="5px" url={props.images.length ? props.images[0].image : ''}   width='15vw' widthmobile="100%" height="auto"   dimensions={{width: 1600, height: 1600}} dimensionsMobile={{width: 1800, height: 1200}}></ImageLoader>
