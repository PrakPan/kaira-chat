...
<div>{props.weekdays ? <Container>
    ...
    <div>
        ...
        <p className="font-nunito" style={{fontWeight: '100', textAlign: 'center', marginBottom: '0.25rem'}}>Usually open from</p>
        <p className="font-nunito" style={{fontWeight: '100', textAlign: 'center'}}>8:00AM - 9:00PM</p>
    </div>
</Container>: null}</div>
);
