...
export default function FlightDetails({
  ...
  return (
    <div className="w-full md:w-[75%] flex flex-col gap-2.5">
      ...
      <div className="flex justify-between items-center text-sm text-[#445069]">
        <span>
      ...
      <div className="flex justify-center items-center">
        {/* Departure Time */}
        <div className="text-md font-medium text-[#0b1220]">
        ...
        {/* Arrival Time */}
        <div className="text-md font-medium text-[#0b1220] flex items-start gap-1">
          <span>
      ...
      <div className="flex justify-between items-center text-sm text-[#445069]">
        <div className="flex items-center gap-1.5">
          ...
          <PiAirplaneTakeoff className="text-[#8a93a6] flex-shrink-0" size={16} />
          <span>{origin?.city_name} <span className="text-[#8a93a6]">({origin?.airport_code || origin?.city_code})</span></span>
        </div>

        {/* Stops Info - Centered */}
        <div className="flex-1 flex justify-center">
          {isNonStop || numStops == 0 ? (
            <div className="text-xs text-[#8a93a6]">Non-Stop</div>
          ) : (
            <div
        ...
        <div className="flex items-center gap-1.5 text-right">
           <PiAirplaneLanding className="text-[#8a93a6] flex-shrink-0" size={16} />
          <span>{destination?.city_name} <span className="text-[#8a93a6]">({destination?.airport_code || destination?.city_code})</span></span>
          {/* <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-gray-600 flex-shrink-0">
