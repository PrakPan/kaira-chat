...
const FlickityCarousel = (props) => {
      ...
      imagesjsx.push(
        <StyledCarouselItem className="center-div">
          <ImageLoader
            borderRadius="50%"
            url={
              props.images[i] ? props.images[i].image : "media/webiste/grey.jpg"
            }
            width="12.5vw"
            widthmobile="100%"
            height="auto"
            dimensions={{ width: 800, height: 800 }}
            dimensionsMobile={{ width: 1800, height: 1200 }}
          ></ImageLoader>
          <Carousel.Caption
  ...
  return (
    <div
      ...
      interval={props.hover ? 1000 : null}
      wrap={false}
      slide={false}
      fade
      activeIndex={index}
    ...
    >
      <ImageLoader
        borderRadius="50%"
        url={
          props.images.length ? props.images[0].image : "media/website/grey.png"
        }
        width="12.5vw"
        widthmobile="25vw"
        height={isPageWide ? "12.5vw" : "25vw"}
        dimensions={{ width: 800, height: 800 }}
