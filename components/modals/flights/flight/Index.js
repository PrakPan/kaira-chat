      ...
      <Container className='border-thn'>
           <GridContainer>
              <ImageContainer className='cente-div'>
                ...
                {props.data ? props.data.Segments?      <div className='font-lexend text-center' style={{fontWeight: '300', fontSize: '0.75rem', margin: '0rem'}}>{props.data.Segments[0][0].Airline.AirlineName}</div>  : null  : null}

                {props.data ? props.data.Segments?      <div className='font-lexend text-center' style={{fontWeight: '300', fontSize: '0.75rem', margin: '0rem'}}>{props.data.Segments[0][0].Airline.AirlineCode + " " + props.data.Segments[0][0].Airline.FlightNumber}</div>  : null : null}
