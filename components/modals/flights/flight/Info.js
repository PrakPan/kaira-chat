       ...
       <DetailsGridContainer>
         <div
           style={{
             ...
             gridColumnGap: isPageWide ? "2.5rem" : "0.5rem",
         ...
         >
           <div style={{ display: "flex", gap: "0.25rem" }}>
             ...
             {props.data ? (
               props.data.Segments ? (
                 <div
                   style={{ margin: "0", fontWeight: "300", fontSize: "1rem" }}
                   className="font-lexend"
                 >
                   {"(" +
                   ...
                   >
                     {"via " +
                       props.data.Segments[0]
                         .slice(1)
                         .map((res) => res.Origin.Airport.CityName + ",")}
                   </div>
                 ) : null
               ) : null
             ) : null}
               ...
               props.data.Segments.length ? (
                 props.data.Segments[0].length > 1 ? (
                   <div
                     ...
                     style={{ fontSize: "0.85rem", fontWeight: "300" }}
                   >
                     {minuteToHours(props.data.Segments[0][1].GroundTime) +
                       " Layover"}
                   </div>
                 ) : null
               ) : null
               ...
               props.data.Segments.length ? (
                 props.data.Segments[0].length === 1 ? (
                   <div
                     ...
                     style={{ fontSize: "0.85rem", fontWeight: "300" }}
                   >
                     {minuteToHours(props.data.Segments[0][0].Duration)}
                   </div>
                 ) : null
               ) : null
             ) : null}
         ...
         >
           ...
           <div className="center-div">
             <Cost className="font-lexend">
               {props.selectedBooking && props.data ? (
                 props.data.Fare ? (
                   props.data.Fare.OfferedFare - props.selectedBooking.cost >
                   0 ? (
                     <FaArrowUp
                       style={{
                         fontWeight: "600",
