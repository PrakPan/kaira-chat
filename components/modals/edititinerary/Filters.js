...
const Filters = (props) => {
    ...
    <div className={classes.root}>
        ...
        <Grid container spacing={2} style={{textAlign: "center"}}>
          <Grid item xs>
            <Slider marks={marks} value={value} onChange={handleChange} aria-labelledby="continuous-slider" style={{width: "80%",}} />
          </Grid>
        </Grid>
        ...
        <FormControlLabel
            control={
            <CustomCheckbox checked={state.checkedA} onChange={handleCheckboxChange} name="checkedA" className={classes.checkbox}
...
>
        <FormControlLabel
            control={<CustomCheckbox checked={state.checkedB} onChange={handleCheckboxChange} name="checkedB" className={classes.checkbox} />}
            label="Adventure"
            className={classes.checkbox}
        ...
        <Grid item xs>
        <FormControlLabel
            control={<CustomCheckbox checked={state.checkedC} onChange={handleCheckboxChange} name="checkedC" className={classes.checkbox}/>}
        ...
        <Grid item xs>        
        <FormControlLabel
            control={<CustomCheckbox checked={state.checkedE} onChange={handleCheckboxChange} name="checkedE"  className={classes.checkbox}/>}
        ...
        <FormControlLabel
            control={
            <CustomCheckbox checked={state.checkedF} onChange={handleCheckboxChange} name="checkedF" className={classes.checkbox}
            iconStyle={{fill: 'black'}}
            />}
            label="Solo"
        ...
        <Grid item>        
        <FormControlLabel
            control={<CustomCheckbox checked={state.checkedG} onChange={handleCheckboxChange} name="checkedG" className={classes.checkbox} />}
            label="Couple"
        />
        </Grid>        
        <Grid item>
        <FormControlLabel
            control={<CustomCheckbox checked={state.checkedH} onChange={handleCheckboxChange} name="checkedH" className={classes.checkbox} />}
            label="Group"
        />
        </Grid>
        <Grid item>
        <FormControlLabel
            control={<CustomCheckbox checked={state.checkedI} onChange={handleCheckboxChange} name="checkedI" className={classes.checkbox} />}
            label="Family"
        />
        </Grid>
        </Grid>
