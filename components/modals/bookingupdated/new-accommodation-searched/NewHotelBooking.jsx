...
const svgIcons = {
  ...
  forkKnife: (
    ...
    >
      <path
        d="M4.5 8.17993L4.125 8.08228C3.62973 7.95376 3.24289 7.69825 2.94629 7.31177C2.64666 6.92116 2.50006 6.4894 2.5 6.00024V1.83325H2.83301V5.83325H4.5V1.83325H4.83301V5.83325H6.5V1.83325H6.83301V6.00024C6.83294 6.48947 6.68643 6.92112 6.38672 7.31177C6.09005 7.69833 5.70342 7.95379 5.20801 8.08228L4.83301 8.17993V14.1663H4.5V8.17993ZM11.167 7.9563L10.8252 7.84204C10.3606 7.68716 9.96663 7.36068 9.65039 6.80981C9.33149 6.25416 9.16699 5.6159 9.16699 4.88306C9.16703 3.98692 9.4016 3.25792 9.84863 2.66821C10.2952 2.07924 10.7855 1.83335 11.333 1.83325C11.879 1.83325 12.3699 2.08008 12.8174 2.67505C13.2656 3.27107 13.5 4.00364 13.5 4.89966C13.5 5.63238 13.3354 6.2666 13.0176 6.81567C12.7019 7.36102 12.308 7.68663 11.8418 7.84204L11.5 7.9563V14.1663H11.167V7.9563Z"
        stroke="#8a93a6"
      />
    </svg>
  ),
  ...
  return (
    ...
    >
      <div>
        ...
        <div className="rounded-3xl border-sm border-solid border-[#ececec] p-md cursor-pointer hover:bg-[#faf9f4] relative">
          <div
            onClick={() => {
              if (booking?.availability) handleViewHotel();
            }}
          ...
          >
            <div className={`relative w-[260px] max-ph:w-full h-[12rem] `}>
              ...
              {booking.star_category && booking.star_category != "0" ? (
                <div
                  starHotel
                  className={` bg-black/55 text-white backdrop-blur absolute rounded-67br text-sm font-500 leading-lg px-md py-xs absolute top-md left-md`}
                >
            ...
            <div className="flex flex-col gap-2 text-[#0b1220] lg:w-[70%] w-full justify-between">
              <div className="flex flex-col gap-sm">
                <div className="mb-0 flex flex-row justify-between">
                  <div className={`text-2xl font-semibold mb-0`}>
                    <p className="text-md-lg leading-xl-sm font-600 mb-0">
                      {" "}
                      {booking?.name}
                    </p>
                  </div>
                  <div>
                    {booking?.refundable && (
                      <p className=" bg-[#e7f5ee] text-[#1f8a5a] px-2 py-2 mb-0 rounded-md text-xs font-medium">
                        Refundable
                      </p>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    {booking?.rating > 0.0 ? (
                      <div className="gap-1 flex flex-row  items-center">
                        ...
                        <div className="text-sm text-[#445069] font-[400]">
                          {booking?.rating}
                        </div>
                  ...
                  <div className="flex flex-row gap-3 lg:mt-2 mt-0">
                    {currentBooking?.check_in && (
                      <div className="flex flex-row gap-2 items-center">
                        ...
                        {svgIcons.calender}
                        <div>
                          <div className="text-sm-md font-400 leading-md text-[#445069] ">
                    ...
                    <div className="text-sm-md font-400 leading-md text-[#445069] gap-2 flex flex-row items-center">
                      {/* <BsPeopleFill className="text-sm text-text-spacegrey" /> */}
                      {svgIcons.user}
                      <div className=" text-sm-md font-400 leading-md text-[#445069] min-w-fit">
                ...
                {booking?.distance_from_city_centre && (
                  <div className="text-sm-md font-400 leading-md text-[#445069] flex gap-2">
                    {/* <FaLocationDot className="text-lg text-text-spacegrey" /> */}
                    {svgIcons.loaction}
                    <>
                      {booking?.distance_from_city_centre} kms from city centre
                    </>
                  </div>
                )}
              </div>
              ...
              {!booking?.availability ? (
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-[#b84034] text-sm-md font-500 leading-lg">
                    This hotel is currently sold out for selected dates
                  </div>
                </div>
              ) : booking?.price ? (
                <div>
                  <div className="flex flex-row md:flex-row gap-1 items-center w-full font-bold">
                    <div className="font-sans text-[#0b1220] text-lg font-700 leading-2xl-md">
                      <>{currency?.currency ? currencySymbols?.[currency?.currency] : '₹'}{getIndianPrice(Math.ceil(booking.price))}</>
                    </div>
                    <div className="text-[#445069] text-sm-md font-400 leading-lg mt-xxs">
                ...
                <div>
                  <div className="text-[#445069] text-sm-md font-400 leading-lg">
          ...
          <div className="absolute right-md bottom-xl max-ph:static">
           {booking?.availability && (
    <button 
      className="ttw-btn-secondary max-ph:w-full max-ph:mt-md" 
