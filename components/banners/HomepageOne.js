  ...
  return (
    <Container>
      ...
      <Heading
        align="center"
        bold
        margin={isPageWide ? "0 auto 2.5rem auto" : "0 auto 1rem auto 0"}
      >
        Let us help you plan your next experience
      </Heading>
      <GridContainer>
        <Button
          external_link="https://www.blog.thetarzanway.com"
          borderRadius="2rem"
          margin="auto"
          padding="0.5rem 2.5rem"
        >
          I need travel inspiration
        </Button>
        <Button
          onclick={_handleGuideClick}
          onclickparams={null}
          margin="auto"
          borderRadius="2rem"
          padding="0.5rem 2.5rem"
