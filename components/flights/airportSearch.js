...
const AirportSearch = ({ input, setInput, name }) => {
  ...
  return (
    <div ref={dropdownRef} className="w-[230px] h-[100px] block text-gray-600 px-2 py-2 font-medium mb-1 border border-gray-300 rounded-md hover:bg-blue-200 focus:ring-2 focus:ring-blue-500 outline-none">
