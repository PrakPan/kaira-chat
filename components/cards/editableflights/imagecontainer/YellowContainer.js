    ...
    return(
                    ...
                    <YellowContainer>
                        <div style={{display: 'grid', gridTemplateColumns: 'auto max-content', margin: '0.5rem 0'}}>
                            ...
                            {props.data.booking_cost && !props.are_prices_hidden ? <div style={{  fontSize:'1rem', overflow: 'hidden'}} className="font-opensans center-div">
                                {"₹ "+IndianPrice+"/-"}
                            </div> : null}
                        </div>
                        ...
                        <DetailsContainer>
                            ...
                            {/* {props.check_in && props.check_out ? <Detail className='font-opensans' style={{textAlign: 'right'}}>{props.getDate(props.check_in) + "," + props.getTime(props.check_in) +  " to " + props.getDate(props.check_out) + "," + props.getTime(props.check_out) }</Detail> : <div></div>} */}
                        </DetailsContainer>
                    </YellowContainer>
