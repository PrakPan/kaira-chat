    ...
    return(
      <Container className='font-lexend'>  
            ...
            <div className="center-dv" style={{ padding: '1rem', borderColor: 'rgba(238, 238, 238, 1)', borderWidth: '1px', borderStyle: 'none solid none none'}}>
              ...
              <ImageLoader  url={props.data.images ? props.data.images.image ? props.data.images.image : "media/icons/bookings/car (2).png" : "media/icons/bookings/car (2).png" }   width="3.5rem" widthmobile="4rem" height="auto" ></ImageLoader>
