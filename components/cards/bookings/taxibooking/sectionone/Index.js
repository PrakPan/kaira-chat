    ...
    return(
      <Container className='font-opensans'>  
            ...
            <div className="center-dv" style={{ padding: '1rem', borderColor: 'rgba(238, 238, 238, 1)', borderWidth: '1px', borderStyle: 'none solid none none'}}>
              ...
              <ImageLoader  blur={!props.data.user_selected} url={props.data.images ? props.data.images.length ? props.data.images[0].image : "media/icons/bookings/car (2).png" : "media/icons/bookings/car (2).png" }   width="3.5rem" widthmobile="4rem" height="auto" ></ImageLoader>
