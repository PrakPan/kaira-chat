...
const Section= (props) => {
    ...
    return(
      <Container>
        <Heading className={props.data.user_selected ? 'font-opensans' : 'font-opensans   '}>{props.rental ? "Self Drive " : props.data.transfer_type === 'Intercity one-way' ? "One-way Taxi" : 'Round-trip Taxi'}</Heading>
      {!props.rental ? <RouteContainer className='font-opensans'>  
