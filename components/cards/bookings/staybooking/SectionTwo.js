      ...
      <Container className="">
        {props.isDatePresent && !props.is_registration_needed ? (
          ...
          >
            ...
            >
              <ImageLoader
                url="media/icons/bookings/stays/check-in.svg"
                height="1.5rem"
                width="1.5rem"
                widthmobile="1.5rem"
            ...
            >
              <ImageLoader
                url="media/icons/bookings/stays/check-out.svg"
                height="1.5rem"
                width="1.5rem"
                widthmobile="1.5rem"
                dimensions={{ width: 100, height: 100 }}
        ...
        {props.is_registration_needed && props.data.duration ? (
          <div
            style={{
              display: "grid",
              gridGap: "0.5rem",
        ...
        >
                ...
                >
                  ...
                  >
                    {rooms[0].number_of_children
                      ? rooms[0].number_of_children === 1
                        ? "1 Child"
                        : rooms[0].number_of_children === "0"
                        ? null
                        : rooms[0].number_of_children + " Children"
                      : null}
                  </Text>
                  <Text
                    className=""
                  ...
                  >
                    {rooms[0].number_of_infants
                      ? rooms[0].number_of_infants === 1
                        ? "1 Infant"
                        : rooms[0].number_of_infants === "0"
                        ? null
                        : rooms[0].number_of_infants + " Infants"
                      : null}
                  </Text>
                </div>
              ) : null}
          ...
          {props.data.costings_breakdown ? (
            props.data.costings_breakdown.length ? (
              props.data.costings_breakdown[0].pricing_type !== "TBO" &&
              props.data.costings_breakdown[0].pricing_type !== "EP" ? (
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns: "max-content auto",
                ...
                >
                  <ImageLoader
                    url="media/icons/bookings/stays/restaurant.svg"
                    height="1.5rem"
                    width="1.5rem"
                    widthmobile="1.5rem"
                    dimensions={{ width: 100, height: 100 }}
        ...
        >
          <ImageLoader
            url="media/icons/bookings/bed.png"
            height="1.5rem"
            width="1.5rem"
            widthmobile="1.5rem"
            dimensions={{ width: 100, height: 100 }}
