...
const Booking = (props) =>{
    ...
    for(var i = 1 ; i <=5 ; i++){
        if(i > props.star_category)  StarsJSX.push(<GrStar style={{fontSize: '0.75rem', lineHeight: '1', opacity: '0.3', marginTop: '-0.1rem'}}></GrStar>)
        else StarsJSX.push(<GrStar style={{fontSize: '0.75rem', lineHeight: '1', marginTop: '-0.1rem'}}></GrStar>)
    }
    return(
