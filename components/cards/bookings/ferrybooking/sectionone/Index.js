    ...
    return(
      <Container className='font-lexend'>  
            ...
            <div className="center-dv" style={{ padding: '1rem', borderColor: 'rgba(238, 238, 238, 1)', borderWidth: '1px', borderStyle: 'none solid none none'}}>
              {/* <DropDown></DropDown> */}
              <p style={{margin: '0 0 0.25rem 0', fontSize: '15px', fontWeight: '700'}} className="font-lexend text-center">{props.data.taxi_type}</p>
              <ImageLoader url={props.data.images ? props.data.images.length ? props.data.images[0].image : "media/icons/bookings/transfers/boat.svg" : "media/icons/bookings/transfers/boat.svg" }   width="3.5rem" widthmobile="4rem" height="auto" ></ImageLoader>
