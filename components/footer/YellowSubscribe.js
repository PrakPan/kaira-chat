    ...
    <Container>
      ...
      <GridContainer>
        <ContentContainer>
          ...
          {isPageWide ? (
            <P>
              We will keep you updated with interesting travel tips,
              breath-taking places, travel facts and so much more.
            </P>
          ) : null}
        </ContentContainer>
        <ContentContainer
          style={{
            borderStyle: isPageWide ? "none solid none solid" : "none",
            borderWidth: "1px",
          }}
        >
          ...
          {isPageWide ? (
            <P>
              Want to find a trip and get 30% off? Along with our partners, we
              will keep you up to date with the latest offers and travel deals.
            </P>
          ) : null}
        </ContentContainer>
        <ContentContainer>
          ...
          {isPageWide ? (
            <P>
              Become a part of our community? Want to travel? Have a question?
              Confused? We're always there and available for you.
            </P>
          ) : null}
        </ContentContainer>
      </GridContainer>
      ...
      <p style={{ textAlign: "center", margin: "3rem auto 0 auto" }}>
        <a href="https://www.instagram.com/thetarzanway" target="_blank">
          <FontAwesomeIcon
            style={{
              color: "black",
              fontSize: isPageWide ? "2rem" : "2.5rem",
              marginRight: "2rem",
            }}
            icon={faInstagram}
          />
        ...
        <a href="https://twitter.com/thetarzanway" target="_blank">
          <FontAwesomeIcon
            style={{
              color: "black",
              fontSize: isPageWide ? "2rem" : "2rem",
              marginRight: "2rem",
            }}
            icon={faTwitter}
          />
        </a>
        <a href="https://linkedin.com/company/thetarzanway" target="_blank">
          <FontAwesomeIcon
            style={{
              color: "black",
              fontSize: isPageWide ? "2rem" : "2.5rem",
        ...
        <a href="https://in.pinterest.com/thetarzanway/" target="_blank">
          <FontAwesomeIcon
            style={{ color: "black", fontSize: isPageWide ? "2rem" : "2.5rem" }}
            icon={faPinterestP}
          />
        </a>
      </p>
