    ...
    <YellowBar>
      <YellowBarContent>
        <div className="center-div">
          <LinkHeading className="font-lexend">
            <b>The Tarzan Way</b>
          </LinkHeading>
          ...
          <IconsContainer>
            ...
            >
              <ImageLoader
                widthtab="25%"
                width="40%"
                url="media/icons/general/personalise.svg"
              ></ImageLoader>
            ...
            <IconContainer>
              <ImageLoader
                widthtab="25%"
                width="40%"
                url="media/icons/general/transparency.svg"
              ></ImageLoader>
              <IconText className="font-lexend">Transparency</IconText>
            </IconContainer>
          </IconsContainer>
          {/*<Link to="https://dev.thetarzanway.com/testimonials" style={{textDecoration: "none", color: "black"}}>*/}
        ...
        <div className="center-div">
          <ImageLoader
            ...
            fit="cover"
            dimensionsMobile={{ width: 1400, height: 900 }}
            width="100%"
            url="media/illustrations/footer.png"
          ></ImageLoader>
        </div>
      </YellowBarContent>
    </YellowBar>
...
{
  /* <a href="https://dev.thetarzanway.com/testimonials">
<Button
link={"https://dev.thetarzanway.com/testimonials"}
borderWidth="2px"
hoverColor="#F7e700"
// borderWidth="1px"
fontSizeMobile="0.75rem"
