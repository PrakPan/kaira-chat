 ...
 * eyebrows don't). `tight` drops the spaces around the cross-month dash —
 * "28 SEP–2 OCT", as the city cover draws it.
 */
export const formatDateRange = (
  startStr,
  endStr,
  { withYear = false, tight = false } = {},
) => {
  ...
  const head = sameMonth
    ...
    : `${a.getDate()} ${SHORT_MONTHS[a.getMonth()]}${tight ? "–" : " – "}${b.getDate()} ${SHORT_MONTHS[b.getMonth()]}`;
