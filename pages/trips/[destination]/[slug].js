...
//
// The empty path list below is normally the failure mode the comment inside
// this function warns about — it is deliberate here: scripts/tripsSeoCache.js
// is commented out of package.json's `prebuild`, so the .seo-cache snapshot
// does not exist in this build and readTripsIndex() would throw. Nothing under
