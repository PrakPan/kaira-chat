...
import ChampionsTrophy from "../../containers/championstrophy";
  ...
  return (
    ...
    >
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://www.thetarzanway.com/event/${slug}`}
        ></link>
      </Head>

      <ChampionsTrophy themePage experienceData={Data} slug={slug}></ChampionsTrophy>
    </Layout>
  );
};
...
export async function getStaticPaths() {
  try {
    const response = await axiosPageList.get("?page_type=Event");
