...
export const applyCoupon = (coupon) => {
    return (dispatch, getState) => {
        ...
        axios.get("https://suppliers.tarzanway.com/payment/coupon/validate/?coupon_code="+coupon+"&sale="+getState().experience.saleId+"&user_email="+getState().auth.email).then(res => {
...
export const startPayment = (amount) => {
    ...
    return (dispatch, getState) => {
        ...
        axios.post("https://apis.tarzanway.com/pay/checkout/", payementInfo, {headers: 
