        ...
        <Container>
                ...
                <Grid container spacing={4}>
                    <Grid item xs={6}>
                        ...
                        <TextField id="outlined-basic"  variant="outlined"  fullWidth placeholder={props.name}   onChange={event => {_userDetailsOnChangeHandler(event,'name')}}/>   
...
const mapStateToPros = (state) => {
  ...
  const mapDispatchToProps = dispatch => {
      return{
        changeUserDetails1: (userDetails) => dispatch(authaction.changeUserDetails(userDetails)),
      }
    }
