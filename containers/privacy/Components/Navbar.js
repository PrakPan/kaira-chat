        ...
        for(var i =0;i<content.length;i++){
    
            {
                ...
                card.push(
                  ...
                  <li  className="nav-item "  style={{backgroundColor: headingCont === content[i].subheading ? '#f7e700' : 'transparent', padding:"0.5rem",fontWeight: headingCont === content[i].subheading ? "600":"400"}} >       
