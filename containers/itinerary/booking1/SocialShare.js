...
export const SocialShare = ({
  ...
  return (
    <div className="w-full flex flex-col gap-3 p-0">
      <div className="ttw-type-h4">Share</div>
      ...
      >
        ...
        <div className="flex items-start justify-between px-3 pt-4">
          <div className="flex-1">
            <h3 className="ttw-type-h5 text-gray-900 leading-tight">
              Planning with friends?
            </h3>
            <p className="ttw-type-body text-gray-500 mt-1">
        ...
        <div className="px-2 pb-1 space-y-1">
          ...
          >
            ...
            <span className="ttw-type-body text-gray-900">Whatsapp</span>
          </button>
          ...
          >
            ...
            <span className="ttw-type-body text-gray-900">Instagram</span>
          </button>
          ...
          >
            ...
            <span className="ttw-type-body text-gray-900">Facebook</span>
          </button>
          ...
          <div className="pt-3 pb-1">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <span className="ttw-type-small text-gray-700">Email</span>
              </button>
              ...
              >
                ...
                <span className="ttw-type-small text-gray-700">
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm animate-popOut flex flex-col justify-center gap-3 items-center">
        ...
        >
          <IoMdClose className="ttw-type-h3" />
        </div>
      </div>
    </div>
  );
