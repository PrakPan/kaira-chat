...
const Details = (props) => {
  ...
  return(
    ...
    <Heading bold margin="0 auto 1.5rem auto" align="center">Book Now</Heading>
        ...
        <Button width="100%" bgColor="#F7e700" borderRadius="5px" borderWidth="0px" margin="0 0 0.5rem 0" onclick={_startCheckoutHandler} >Proceed</Button>
