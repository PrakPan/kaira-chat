...
const Register = (props) => {
    ...
    const _submitHandler = () => {
         axios.post("https://suppliers.tarzanway.com/campaign/response/", {
  ...
  return (
    <Container>
        <DescriptionContainer>
            <Description className="font-nunito">Hey there! Before you start your travel experience we need to make sure that you are well aware of the itinerary you'll be following and read the terms and conditions that make you a responsible traveler. Please fill the really short form below and read the terms carefully. Happy Journey!</Description>
        </DescriptionContainer>
            <PersonalDetails
