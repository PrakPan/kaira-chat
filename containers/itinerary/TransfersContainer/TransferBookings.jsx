...
<div>
  <>
    ...
    {(
      <TransferBooking
        ...
        key={transferBooking?.intercity[
          `${itineraries?.start_city?.gmaps_place_id}:${itineraries?.cities?.[0]?.id}`
        ]?.id}
        index={-1}
        booking={transferBooking?.intercity[
          `${itineraries?.start_city?.gmaps_place_id}:${itineraries?.cities?.[0]?.id}`
        ]}
  ...
  {itineraries?.cities?.length > 0 && (
    <>
      <PinSection
        key={`last-${itineraries?.cities?.[itineraries?.cities.length - 1]?.id}`}
        transfersPin
        setCurrentPopup={false}
        city={itineraries?.cities?.[itineraries?.cities.length - 1]?.city.name}
      ...
      <TransferBooking
        ...
        loadbookings={props?.loadbookings}
        key={transferBooking?.intercity[
          `${itineraries?.cities?.[itineraries?.cities.length - 1]?.id}:${itineraries?.end_city?.gmaps_place_id}`
        ]?.id}
        index={itineraries?.cities.length - 1}
        booking={transferBooking?.intercity[
          `${itineraries?.cities?.[itineraries?.cities.length - 1]?.id}:${itineraries?.end_city?.gmaps_place_id}`
        ...
        selectedBooking={selectedBooking}
        setSelectedBooking={setSelectedBooking}
        originCityId={itineraries?.cities?.[itineraries?.cities.length - 1]?.id}
