    ...
    router.push(
      {
        ...
        query: {
          ...
          dItineraryCity:
            dItineraryCityId || dCityData?.id || dCityData?.gmaps_place_id,
        },
      },
      undefined,
      {
                      ...
                      <div className=" w-full items-center">
                        <div className="font-medium text-[15px] flex items-center gap-2">
                          ...
                          {isIntracity ? (
                            ...
                            <>
                              {booking?.transfer_details?.source?.name ||
                                booking?.transfer_details?.source
                                  ?.city_name}{" "}
                              <svg
                                width="12"
                                height="12"
                      ...
                      >
                        ...
                        {!isPageWide &&
                          ...
                          (() => {
                            ...
                            // Show only if at least one exists
                            if (!seatingCapacity && !bagCapacity && !fuelType)
                              return null;
