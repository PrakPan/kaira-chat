...
const Timer = (props) => {
  ...
  const ITINERARY_TIMER_MESSAGE =
    "Your tailor made plan is ready. As a next step to get to know you better, our travel expert will reach out to you to prepare the perfect plan.";
  const BOOKING_TIMER_MESSAGE =
  ...
  let message =
    "Hi TTW,%0AHere is my travel plan:%0A%0A" +
    window.location.href +
    "%0A%0AI would like to ask something.";
        ...
        return (
          <InnerContainer
            style={{
              ...
              boxShadow:
                "0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.34)",
              borderStyle: "none",
              zIndex: "1",
            }}
          ...
          >
            {!props.hideTimer ? (
              <FontAwesomeIcon
                icon={faTimes}
                onClick={props._handleTimerClose}
                style={{
                  margin: "0.5rem",
                  position: "absolute",
                  top: "0",
            ...
            {props.hideTimer ? null : (
              ...
              >
                {props.booking
                  ? BOOKING_TIMER_MESSAGE
                  : ITINERARY_TIMER_MESSAGE}
              </p>
            )}

            <ButtonsContainer>
              {props.hideTimer || props.booking ? null : (
                <Button
                  hoverColor="white"
                  width="100%"
                  hoverBgColor="black"
      ...
      return (
        <InnerContainer
          style={{
            ...
            borderWidth: "5px",
            borderColor: props.hideTimer
              ? "rgba(0, 0, 0, 0.3)"
              : "rgba(0, 0, 0, 0.3)",
            boxShadow: props.hideTimer
        ...
        >
          <div
            style={{
              backgroundColor: !props.hideTimer ? "#f7e700" : "transparent",
              paddingTop: "0",
              margin: "0",
            }}
          >
            ...
            >
              <TimeCircle
                ...
                style={{
                  width: props.hideTimer ? "100%" : "28.3vw",
                  minHeight: props.hideTimer ? "max-content" : "22vw",
                  padding: "0.25rem",
                }}
              >
                <TimeNumber
      ...
      return (
        ...
        >
          ...
          {props.hideTimer ? null : (
            ...
            >
              {props.booking ? BOOKING_TIMER_MESSAGE : ITINERARY_TIMER_MESSAGE}
            </p>
          )}
