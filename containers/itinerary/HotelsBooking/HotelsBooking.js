...
const HotelsBooking = (props) => {
  ...
  return (
    <div id="stays" className="lg:w-[60vw] w-full lg:mx-0 lg:mt-16">
      <div
        id="staysBooking"
        className="cursor-pointer mb-2 mt-8 font-bold ttw-type-h1 group text-[#262626] transition duration-300 max-w-fit"
      >
        Stays
      ...
      <div className=" fixed right-[10px] top-[50px] z-[200] ">
        {isError.error && (
          <Slide
            ...
            ydistance={25}
          >
            <div className="text-white px-2 py-1 border-2 border-red bg-red-500 rounded-lg text-center font-normal ttw-type-body ">
              {isError.errorMsg}
            </div>
          </Slide>
        )}
