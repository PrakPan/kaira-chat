...
const RouteIndex = (props) => {
  ...
  if (props.breif)
    if (props.breif.city_slabs) {
      for (var i = 0; i < props.breif.city_slabs.length; i++) {
        if (props.breif.city_slabs[i].is_starting_city_departure_only)
          startingcity = props.breif.city_slabs[i].city_name;
        ...
        if (
          ...
          !props.breif.city_slabs[i].is_starting_city_departure_only &&
          ...
          locationsArr.push(<InterConnect></InterConnect>);
        }
      }
  ...
  return (
    <GridContainer>
      <div>
        <EndLocation
          location={props.nostartinglocation ? "Your Location" : startingcity}
        ></EndLocation>
        <InterConnect></InterConnect>
        {locationsArr}
        <EndLocation
          location={props.nostartinglocation ? "Your Location" : endingcity}
        ></EndLocation>
      </div>
      <div></div>
    </GridContainer>
