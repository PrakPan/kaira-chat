    ...
    <div>
      {props.showTimer ? (
        <Timer
          ...
          hideTimer={true}
          _handleTimerClose={_handleTimerClose}
      ...
      <Container>
        {isPageWide ? (
          <Heading color="black" margin="0 0 1rem 0" bold>
            Route
          </Heading>
        ) : (
          <Heading color="black" align="center" margin="0 0 2rem 0" bold>
            Route
          </Heading>
        )}
        <Route breif={props.breif}></Route>
        {true ? (
          <Heading color="black" margin="2rem 0" align="center" bold>
            Overview
          </Heading>
        ) : null}
