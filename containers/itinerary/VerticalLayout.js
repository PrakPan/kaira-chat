...
const CityItem = ({
  ...
  const correctIcon = (TransportMode) => {
    switch (TransportMode) {
      case "Flight":
        return <MdOutlineFlightTakeoff className="text-2xl text-[#1F1F1F]" size={16} color={"#1F1F1F"}/>;
      case "Taxi":
      case "Car":
      ...
      case "Bus":
        return <FaBus className="text-2xl text-[#1F1F1F]" size={16} color={"#1F1F1F"}/>;
      default:
        return null;
    }
  };
