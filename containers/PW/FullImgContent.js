  ...
  return (
    <Container className=" center-di text-center">
      <PaddingContianer>
        ...
        <SubText style={{ fontWeight: "600" }}>#pwtraveltogether</SubText>
        <SubText>
        ...
        >
          ...
          <StyledA href="#link">
            How it works
            <BsYoutube
              style={{ marginLeft: "0.5rem", marginTop: "-0px" }}
            ></BsYoutube>
          </StyledA>
        </div>
      </PaddingContianer>
      ...
      <LogosContainer>
        ...
        >
          <ImageLoader
            leftalign
            url="media/website/pwlogo.png"
            width="3rem"
            widthmobile="2rem"
            height="auto"
          ></ImageLoader>

          <LogoText className="font-opesans hden-mobile" style={{}}>
            Physics Wallah
          </LogoText>
        </div>
