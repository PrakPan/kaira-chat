...
const BannerMobile = (props) => {
  ...
  return(
    <Container className="" style={{borderRadius: '0'}}>
        ...
        <Button onclick={_handleRedirect} onclickparam={null} hovercolor="white" hoverbgcolor="black" fontWeight='600' padding="0.75rem" bgColor="#F7e700" borderWidth="1px" borderRadius="2rem"  margin="0" width="100%" >
