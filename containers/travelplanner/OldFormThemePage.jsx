...
export default function ThemePage(props) {
  ...
  const handlePlanButton = (pageId='1', destination="home", type="default") => {
    router.push({
  ...
  return (
    <div className="mb-5">
      ...
      {props?.slug === "ladakhh" ? (
        ...
        //   slug={props.slug}
        // />
        props?.slug != 'AI-generic' && <HeroSection title={props.experienceData.banner_heading}
                    ...
                    {component.carousel === "destination-1" ? (
                      <>
                        <Destination1Carousel
                          ...
                          setShowTailoredModal={handlePlanButton}
                          packages={[
