...
const Team = (props) => {
  ...
  const team = [
    ...
    },
    {
      ...
      image:
        "media/website/323897539_1402891100515796_2539841130125477535_n.jpg",
    },
    {
      name: "Devansh Chawla",
  ...
  const cards = [
    <Card
      ...
      text={team[0].text}
      tagline={team[0].tagline}
      url={team[0].image}
    ></Card>,
    <Card
      name={team[1].name}
      designation={team[1].designation}
      text={team[1].text}
    ...
    <Card
      name={team[2].name}
      designation={team[2].designtaion}
      text={team[2].text}
    ...
    <Card
      name={team[3].name}
      designation={team[3].designtaion}
      text={team[3].text}
      tagline={team[3].tagline}
      url={team[3].image}
    ></Card>,
    <Card
      name={team[4].name}
      designation={team[4].designtaion}
      text={team[4].text}
      tagline={team[4].tagline}
      url={team[4].image}
    ></Card>,
  ];
