...
const Option = (props) => {
    ...
    useEffect(() => {
        ...
        if(questions.questions[props.questionIndex] === questioncontansts.PAX) {
            if(props.newAnswers[questioncontansts.PAX]){
                if(props.newAnswers[questioncontansts.PAX]["index"] === props.index) setSelectedState(true);
            ...
            if(props.newAnswers){
                if(props.newAnswers[questions.questions[props.questionIndex]]){
                    if(props.newAnswers[questions.questions[props.questionIndex]].indexOf(props.index) !== -1 ){
    ...
    const _selectOptionHandler = () => {
        ...
        if(selectedState){
            ...
            if( questions.questions[props.questionIndex] !== questioncontansts.BUDGET ||  questions.questions[props.questionIndex] !== questioncontansts.PAX){
                ...
                let UPDATED_FILTERED =  [...props.newAnswers[questions.questions[props.questionIndex]].filter(function(value, index, arr){ return value != props.index;})]
                 //Set new answers after filtering out unselected option
                 UPDATED_NEW_ANSWERS[questions.questions[props.questionIndex]] = UPDATED_FILTERED;
                 }
        ...
        //Option is selected
            ...
            //PAX question
             if(questions.questions[props.questionIndex] === questioncontansts.PAX){
            ...
            else if(questions.questions[props.questionIndex] === questioncontansts.BUDGET||questions.questions[props.questionIndex] === questioncontansts.DURATION ){
                UPDATED_NEW_ANSWERS[questions.questions[props.questionIndex]]= [];
                UPDATED_NEW_ANSWERS[questions.questions[props.questionIndex]].push(props.index);
                props.setNewAnswers(UPDATED_NEW_ANSWERS);
                ...
                if(props.newAnswers){
                    let newarr = []
                    if(props.newAnswers[questions.questions[props.questionIndex]]){
                        for(var i = 0 ;i < props.newAnswers[questions.questions[props.questionIndex]].length ; i++){
                            newarr.push(props.newAnswers[questions.questions[props.questionIndex]][i])
                        }
                        UPDATED_NEW_ANSWERS[questions.questions[props.questionIndex]] = newarr;

                    }
                }
                else  UPDATED_NEW_ANSWERS[questions.questions[props.questionIndex]] = [];
