    ...
    */}
    const reviews = [
        ...
        },
        {
            ...
            location: "india",
            review: "The safari arranged by then was great. The driver who took us for the safari was very friendly and nice. Thanks a lot Tanvi! Your entire team has been very very supportive . Wouldn't have been possible to have such a good trip without you guys",
            summary: "Thanks a lot Tanvi! Your entire team has been very very supportive. Wouldn't have been possible ..."
        },
        {
            name: "Aastha Narula",
            image: "media/website/Aastha Narula1.jpeg",
            location: "india",
            review: "It was a wonderful experience with The Tarzan Way. Specially the efforts made by the coordinator were highly appreciated. Everything was good. We had some issues with the hotel but that was also very well handled by the coordinator. So overall it was a great experience. We can plan another trip with the same company and their team.",
    ...
    for( var i =0 ; i < reviews.length; i++){
        FlickityCards.push(
                <ReviewCard text={reviews[i].summary} review={reviews[i].review} name={reviews[i].name} location={reviews[i].location} url={reviews[i].image}></ReviewCard>
        )
    }
    if(isPageWide){
        if(!isPageWide) //chage to ipdad
        return (
        ...
        <div style={{background: "#F7e700"}}>
            ...
            <ReviewColumnContainer>
                ...
                <ReviewCard text={reviews[4].summary} review={reviews[4].review} name={reviews[4].name} location={reviews[4].location} url={reviews[4].image}></ReviewCard>
