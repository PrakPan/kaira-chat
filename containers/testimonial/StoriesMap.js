...
const reveiws = [
  {
    ...
    review:
      'Soulful experience! I had my yoga trip in India and these guys saved me tons of money. Will be back soon haha!',
  },
  {
    name: 'Damla Gürsoy',
    review:
      'Spent the best time volunteering in India with these guys! The Customer Support team is the very helpful. Wish you luck!',
    image: 'media/website/Damla.png',
  },
  {
    name: 'Arnab Roy',
    review:
      'The travel itineraries are beyond imagination with the most local and cultural places covered. Good going guys!',
    image: 'media/website/Arnab.png',
  },
  {
    name: 'Maria Carolina',
    review:
      'The only travel company in India I can trust! Will visit again for one of their mindblowing experiences. Lots of love!',
    image: 'media/website/Maria Carolina.png',
  },
  {
    name: 'Raghav Bansal',
    review:
      'The staff was very supportive. We got exactly what we needed, and it was so flexible!! 100% recommended!',
    image: 'media/website/Raghav-min.png',
  },
  {
    name: 'Mohamed Zaghloul',
    review:
      'My best friends in India!!! I spent 6 months with them, and before you go anywhere in India, just call them once. :D',
    image: 'media/website/Mohamed.png',
  },
  {
    name: 'Shivam Sachdev',
    review:
      'It was a great experience from the planning to booking. The team is really polite and helpful with all your requests',
        ...
        <div>
          ...
          <Container>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip2}>
              <UserIcon style={{ left: '59%', top: '34.5%' }}>
                <Image objectFit="cover" height={50} src={damla}></Image>
              </UserIcon>
            </OverlayTrigger>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip3}>
              <UserIcon style={{ left: '72.5%', top: '45.5%' }}>
                <Image objectFit="cover" height={50} src={arnab}></Image>
              </UserIcon>
            </OverlayTrigger>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip4}>
              <UserIcon style={{ left: '46%', top: '39.5%' }}>
                <Image objectFit="cover" height={50} src={maria}></Image>
              </UserIcon>
            </OverlayTrigger>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip5}>
              <UserIcon style={{ left: '70%', top: '44.5%' }}>
                <Image objectFit="cover" height={50} src={raghav}></Image>
              </UserIcon>
            </OverlayTrigger>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip6}>
              <UserIcon style={{ left: '50%', top: '38.5%' }}>
                <Image objectFit="cover" height={50} src={mohamed}></Image>
              </UserIcon>
            </OverlayTrigger>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip7}>
              <UserIcon style={{ left: '25%', top: '38.5%' }}>
                <Image objectFit="cover" height={50} src={shivam}></Image>
              </UserIcon>
            </OverlayTrigger>
            <MapContainer>
      ...
      return (
        <div>
          ...
          <Container>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip2}>
              <UserIcon style={{ left: '30rem', top: '41.5%' }}>
                <Image objectFit="cover" src={damla}></Image>
              </UserIcon>
            </OverlayTrigger>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip3}>
              <UserIcon style={{ left: '35.3rem', top: '58.5%' }}>
                <Image objectFit="cover" src={arnab}></Image>
              </UserIcon>
            </OverlayTrigger>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip4}>
              <UserIcon style={{ left: '5rem', top: '34.5%' }}>
                <Image objectFit="cover" src={maria}></Image>
              </UserIcon>
            </OverlayTrigger>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip5}>
              <UserIcon style={{ left: '13.7rem', top: '56.5%' }}>
                <Image objectFit="cover" src={MapPin}></Image>
              </UserIcon>
            </OverlayTrigger>
            ...
            <OverlayTrigger placement="top" overlay={Tooltip6}>
              <UserIcon style={{ left: '16.8rem', top: '64.5%' }}>
                <Image objectFit="cover" src={shivam}></Image>
              </UserIcon>
            </OverlayTrigger>
