        ...
        <Container>
            ...
            <InnerContainer>
                   <div>
                    ...
                    <GridContainer>
                        <LogoOuterContainer className="center-div" onMouseEnter={() => setSelected(0)} style={{borderColor: selected === 0 ? '#F7e700' : 'transparent'}} ><LogoContainer className="center-div"><NewImg src={'https://d31aoa0ehgvjdi.cloudfront.net/media/website/outlook.png'} /></LogoContainer></LogoOuterContainer>
