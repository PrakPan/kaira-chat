...
const BannerMobile = (props) => {
  ...
  return(
    <Container className="border" style={{borderRadius: '0'}}>
        ...
        <Button boxShadow onclick={props.onclick} hovercolor="white" hoverbgcolor="black" padding="0.75rem" bgColor="#F7e700" borderWidth="0" borderRadius="2rem" margin="0" width="100%" ><p className="font-opensans" style={{margin: '0', fontWeight: '400'}}>Craft your own experience</p></Button>
   </Container>
  );
}
