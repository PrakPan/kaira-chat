...
const BannerMobile = (props) => {
  ...
  return(
    <Container className="" style={{borderRadius: '0'}}>
        ...
        <Button fontWeight='600' onclick={props.onclick} hovercolor="white" hoverbgcolor="black" padding="0.75rem" bgColor="#F7e700" borderWidth="0" borderRadius="5px" margin="0" width="100%" ><p className="font-opensans" style={{margin: '0', fontWeight: '600'}}>Try our free trip planner now!</p></Button>
   </Container>
  );
}
