...
const Explorers= (props) => {
    ...
    return(
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('506ed241-dc09-4498-ac0a-d78c19f2d574')}>
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('d8ed95ae-3eff-4fdd-b5f2-8e81d67f4dbd')}>
        <ImageFade><ImageLoader
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('40b075cc-3a2c-4643-aae4-687bbd7b2004')}>
        <ImageFade><ImageLoader
          ...
          <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('c333c311-2ba9-4679-9b02-7f941d08f0db')}>
        <ImageFade><ImageLoader
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('7d6233b7-02c4-454c-9452-3e20c242cc13')}>
        <ImageFade><ImageLoader
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('59e104e7-2e75-4df7-94ec-d356c02b479e')}> 
        <ImageFade><ImageLoader
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('0ec9c580-92aa-4dd6-8681-7e6eb18cca0c')}>
        <ImageFade><ImageLoader
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('70b98d5c-7595-40bb-8182-61e0230241e0')}>
        <ImageFade><ImageLoader
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('a2abace4-2350-4f06-a4da-6024432de316')}>
        <ImageFade><ImageLoader
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('3c27ed35-1bee-4a0c-b0c5-b22d34184e73')}>
        <ImageFade><ImageLoader
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('9cfed405-3fed-4f80-b513-c2c9ff86b119')}>
        <ImageFade><ImageLoader
        ...
        <ImageContainer className='hover-pointer' onClick={(e) => _handleRedirect('e2a07637-b53e-40a8-8c0f-c91adcd95223')}>
        <ImageFade><ImageLoader
