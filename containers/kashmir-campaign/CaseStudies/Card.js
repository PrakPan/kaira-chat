...
const CardContainer = (props) => { 
    ...
    return (
            ...
            <Card className='border center-v text-cener' onClick={isPageWide && props.id ? _handleItineraryRedirect : null} >
                ...
                {props.id ? <div className='hidden-desktop'><Button onclick={_handleItineraryClick} margin="1rem 0 0 0.5rem" fontSize="0.85rem" padding="0.25rem 1rem" borderRadius="2rem" borderWidth="0px" bgColor="#f7e700" fontSizeDesktop="0.85rem">View Plan</Button></div>:null}
            </Card>
