    ...
    <>
      ...
      {/* <IconListContainer>
       ...
       <Gallery setGalleryOpen={props.setGalleryOpen} images={props.images} ></Gallery>
        <IconListContainer>
        <DetailsContainer>
            <ExperienceName className='font-opensans' style={{fontSize: '2rem'}}>{"Things to do in "+props.title}</ExperienceName>
            <TagsContainer>
            <TagContainer>
            ...
            <TagContainer>
              <FontAwesomeIcon icon={faCalendar} style={{ fontSize: "2.5vh"}}></FontAwesomeIcon>
              <p className="font-nunito" style={{margin: "0.5rem"}}>{!props.duration === 'null Days' ? props.duration: '4 Days'}</p>
            </TagContainer>            
            <TagContainer>
              <FontAwesomeIcon icon={faMountain} style={{ fontSize: "2.5vh"}}></FontAwesomeIcon>
