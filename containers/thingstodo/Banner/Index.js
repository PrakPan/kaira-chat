...
`;
   return( 
    ...
    <div>
     ...
     <div>
            <Button boxShadow borderRadius="5px" borderWidth="0px" bgColor="#F7e700" color="black" padding="0.5rem 1rem" margin="0.5rem 0" onclick={props.openBooking}>Start Planning</Button>
    </div>
    </Container>
    </FixedContainer>
  );
