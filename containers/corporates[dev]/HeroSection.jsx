...
export default function HeroSection({setFormData,formData,setIsModalOpen,isModalOpen}) {
    ...
    <div className=" bg-[#ffffe7] flex flex-col w-full mb-3 lg:mb-7">
        ...
        <div className="!hidden lg:!grid lg:grid-cols-12 gap-3 xl:gap-4">
          ...
          <div className="col-span-2 flex flex-col gap-3 xl:gap-4">
            <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[12.5rem]">
              <img src={images[0]} alt="Team activity" className="w-full h-full object-cover" />
            </div>
            <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[10.5rem]">
              <img src={images[1]} alt="City tour" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="col-span-2 flex flex-col gap-3 xl:gap-4">
            <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[11rem]">
              <img src={images[3]} alt="Outdoor activity" className="w-full h-full object-cover" />
            </div>
            <div className="bg-[#FFD700] rounded-2xl xl:rounded-3xl p-4 xl:p-6 text-center flex flex-col justify-center h-[13rem]">
              <div className="text-3xl xl:text-5xl font-bold text-gray-900 mb-1">90+</div>
              <div className="text-gray-900 font-medium text-xs xl:text-sm">Tour<br />Destinations</div>
            </div>
            <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[13rem]">
              <img src={images[4]} alt="Team games" className="w-full h-full object-cover" />
            </div>
          </div>
          ...
          <div className="col-span-4 flex flex-col gap-3 xl:gap-4">
            ...
            <div className="grid grid-cols-3 gap-3 xl:gap-4">
              <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[9rem] xl:h-45">
                <img src={images[5]} alt="Group event" className="w-full h-full object-cover" />
              </div>
              <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[9rem] xl:h-45">
                <img src={images[6]} alt="Team building" className="w-full h-full object-cover" />
              </div>
              <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[9rem] xl:h-45">
                <img src={images[7]} alt="Corporate event" className="w-full h-full object-cover" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 xl:gap-4">
              <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[9rem] xl:h-45">
                <img src={images[8]} alt="Office activity" className="w-full h-full object-cover" />
              </div>
              <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[9rem] xl:h-45">
                <img src={images[9]} alt="Mountain view" className="w-full h-full object-cover" />
              </div>
              <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[9rem] xl:h-45">
                <img src={images[10]} alt="Team photo" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
          ...
          <div className="col-span-2 flex flex-col gap-3 xl:gap-4">
            <div className="bg-[#FFD700] rounded-2xl xl:rounded-3xl p-4 xl:p-6 text-center flex flex-col justify-center h-[11.5rem] xl:h-45">
              <div className="text-3xl xl:text-5xl font-bold text-gray-900 mb-1">15K+</div>
              <div className="text-gray-900 font-medium text-xs xl:text-sm">Travellers<br />Hosted</div>
            </div>
            <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[12.5rem] xl:h-45">
              <img src={images[11]} alt="Adventure" className="w-full h-full object-cover" />
            </div>
           
            <div className="bg-[#FFD700] rounded-2xl xl:rounded-3xl p-4 xl:p-6 text-center flex flex-col justify-center h-[13rem] xl:h-45">
              <div className="text-3xl xl:text-5xl font-bold text-gray-900 mb-1">5K+</div>
              <div className="text-gray-900 font-medium text-xs xl:text-sm">Experiences<br />Delivered</div>
            </div>
          </div>

          <div className="col-span-2 flex flex-col gap-3 xl:gap-4">
            <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[12.5rem] xl:h-45">
              <img src={images[12]} alt="Team gathering" className="w-full h-full object-cover" />
            </div>
            <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[10.5rem] xl:h-45">
              <img src={images[13]} alt="Outdoor fun" className="w-full h-full object-cover" />
            </div>
             <div className="rounded-2xl xl:rounded-3xl overflow-hidden h-[13rem] xl:h-45">
              <img src={images[14]} alt="Sunset" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
        ...
        <div className="lg:hidden grid grid-cols-2 gap-3">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-[#FFD700] rounded-2xl p-4 text-center h-[10rem] flex flex-col justify-center">
              ...
              <div className="text-gray-900 font-medium text-xs">Tour<br/>Destinations</div>
            </div>
            <div className="rounded-2xl overflow-hidden h-[10rem]">
              <img src={images[1]} alt="City tour" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="text-gray-900 font-medium text-xs">Experience<br/>Delivered</div>
          </div>
            </div>
          </div>
      ...
      <section className="border rounded-6xl border-gray-200 bg-white py-2 lg:py-2 ml-4 mr-4">
        <div className="container mx-auto px-4">
          <div className="flex overflow-scroll justify-evenly items-center gap-6 lg:gap-12">
