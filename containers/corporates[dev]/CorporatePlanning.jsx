...
const CorporatePlanning = () => {
  ...
  const journeyFeatures = [
    {
      ...
      description:
        "We start by understanding your goals, team size, travel plans, and objectives.",
      iconBgColor: "#FFF9DC",
    },
    {
      id: 2,
      ...
      description:
        "Our team designs custom experiences with handpicked activities, stays, and clear pricing.",
      iconBgColor: "#FAEBEA",
    },
    {
      id: 3,
      icon: <DollarIcon />,
      title: "Coordination & Partnerships",
      description:
        "We handle every detail with reliable partners to keep your experience smooth and safe.",
      iconBgColor: "#EBFFED",
    },
    {
      id: 4,
  ...
  return (
    <section
      ref={containerRef}
      className="py-12 sm:py-16 lg:py-24 max-sm:px-2 sm:px-4 lg:px-8 bg-[#fffacd]"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-12 lg:mb-16">
          {journeyFeatures.map((feature) => (
            <div
              key={feature.id}
              className="rounded-2xl p-6 lg:p-8 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-white bg-white"
            >
              {/* Icon */}
              <div
