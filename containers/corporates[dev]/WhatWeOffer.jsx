    ...
    const handleCreateTripButton = () => {
        ...
        logEvent({
            ...
            params: {
                ...
                event_label: "Plan Itinerary Now!",
                event_action: "What We Offer",
            },
        });
    };

    return (
        <div className="mt-5 py-5 flex flex-col md:flex-row">
            <div className="px-2 md:px-0">
                <ImageLoader url={"media/corporates/whatweoffer.jpeg"} width={isPageWide ? 580 : 290} height={isPageWide ? 600 : 300} borderRadius={8} />
            </div>
            <div className="pt-3 pb-3 pl-3 pr-3 md:py-5 md:px-16 flex flex-col gap-4">
                <div className="text-[27px] md:text-[40px] font-[700] leading-[52px]">What We Offer?</div>
                <div className="flex flex-col gap-3 text-[16px] font-[400] leading-[28px]">
                    <div className="">Explore the world with curated travel experiences that cater to every adventurer. We offer personalized itineraries, unique accommodations, and immersive activities that go beyond the typical tourist spots. Whether you're seeking a tranquil retreat, an adrenaline-pumping adventure, or a cultural deep dive, our expertly crafted trips ensure you experience the best of each destination. Let us handle the details while you focus on creating unforgettable memories.</div>
