...
useEffect(() => {
  if(props.token)
  setName(getFirstName(props.name));
}, [props.name]);
...
if(props.token && props.phone && props.phone !== 'null')
    ...
    <Container component="main" className={classes.box} maxWidth="xs">
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
                ...
                <Button boxShadow hoverBgColor="black"  onClick={() => _submitHandler()} width="100%" bgColor="#F7e700" hoverColor="black" borderRadius="5px" borderWidth="0px" margin="0" >
                    Continue{loading ? <Spinner display="inline" size={16} margin="0 0 0 0.5rem"></Spinner> : null}
                </Button>
  ...
  <LoginContainer className="border-thin" style={{width: props.bookings ? '100%' : '35%'}}>
      ...
      {/* <SharedButton onclick={()=> window.location.href="https://wa.me/919625509382?text="+message} hoverColor="black" hoverBgColor="#128C7E"  onclickparam={null}  width="90%" bgColor="white" borderRadius="2rem" borderWidth="1px" borderColor="#e4e4e4"   margin="auto" >
        <FontAwesomeIcon icon={faWhatsapp} style={{marginRight: "0.5rem"}}/>
         Connect on WhatsApp</SharedButton> */}
         <SharedButton boxShadow onclick={()=> window.location.href="https://wa.me/919625509382?text="+message} hoverColor="black" hoverBgColor="#128C7E"  onclickparam={null}  width="90%" bgColor="white" borderRadius="2rem" borderWidth="1px" borderColor="#e4e4e4"   margin="auto" >
        <FontAwesomeIcon icon={faWhatsapp} style={{marginRight: "0.5rem"}}/>
         Connect on WhatsApp</SharedButton>
  </LoginContainer>
  )
