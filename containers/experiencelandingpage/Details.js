    ...
    <div style={{color: 'black'}} >
      ...
      <DetailsContainer>
        ...
        <div id='overview' >
          <Row class="experience-headings" heading='Overview'>
            <InformationTextContainer
              type='text'
              text={props.data.overview}></InformationTextContainer>
          </Row>
        </div>
        </div>
        <div   >
        {props.data.locations ?  props.data.locations.length ? 
          <div id='route'>
          <Row class="experience-headings" heading={props.data.locations.length > 1 ? "Route" : 'Location'}  >
       ...
       <div className='hidden-desktop'><Banner openItinerary={props.openItinerary} color="black" buttonbgcolor="#F7e700" onclick={props.openBooking}></Banner></div>
