...
import { makeStyles, Theme } from '@mui/material/styless';
  ...
  return (
    <div className={classes.root}>
              ...
              <DiscountContainer>
                <StrikedCost>
                  {'₹ ' +
                    getIndianPrice(
                      Math.round(
                        Math.round(props.data.starting_price / 100) * 1.15
                      )
                    )}
                </StrikedCost>
                <Cost className="font-lexend">
                  {'₹ ' +
                    getIndianPrice(
                      Math.round(props.data.starting_price / 100)
                    ) +
                    ' /-'}
                </Cost>
              </DiscountContainer>
      ...
      <TabPanel value={value} index={2}>
        ...
        {true ? (
          <Booking
            starting_price={props.data.starting_price}
            setGalleryOpen={() => props.setGalleryOpen(true)}
            setGalleryImages={(imagesArr) => props.setGalleryImages(imagesArr)}
