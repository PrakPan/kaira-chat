    ...
    <Container className="border center-div">
      ...
      {!submitted ? (
        <Grid container spacing={2}>
          ...
          <Grid item xs={4}>
            <TypeAdult setAdults={setAdults}></TypeAdult>
          </Grid>
          <Grid item xs={4}>
            <TypeChild setChildren={setChildren}></TypeChild>
          </Grid>
          <Grid item xs={4}>
            <TypeInfant setInfants={setInfants}></TypeInfant>
          </Grid>
          <Grid item xs={12}>
  ...
  onClose={() => setCalendarOpen(false)}
      ...
      />
          ...
          {props.starting_price ? (
            ...
            >
              ...
              <Cost className="font-lexend">
                {"₹ " +
                  getIndianPrice(Math.round(props.starting_price / 100)) +
                  " /-"}
              </Cost>
            </div>
          ) : null}
        ...
        <div>
          {/* <Cost>Rs 1000/-</Cost> */}
          <ImageLoader
            url="media/illustrations/undraw_happy_news_re_tsbd.svg"
            width="50%"
            widthmobile="50%"
          ></ImageLoader>
          ...
          <Subheading className="font-lexend">
            Our travel experts will get in touch with you in the next 2 hours to
            complete your plan{" "}
          </Subheading>
