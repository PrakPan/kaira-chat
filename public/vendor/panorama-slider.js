...
const Ee = (e, s) => {
  ...
  !n ||
    typeof n == "string" ||
    (t[a]("touchstart", e.onDocumentTouchStart, {
      passive: !1,
      capture: o,
    }),
    ...
    if (c.type === "bullets") {
      ...
      for (let P = 0; P < y; P += 1)
        c.renderBullet
          ...
          : (b += `<${c.bulletElement} ${e.isElement ? 'part="bullet"' : ""} class="${c.bulletClass}"></${c.bulletElement}>`);
    }
    (c.type === "fraction" &&
      (c.renderFraction
    ...
    t("click", (c, u) => {
      ...
      if (
        ...
        (i(y === !0 ? "paginationShow" : "paginationHide"),
          b.forEach((P) =>
            P.classList.toggle(e.params.pagination.hiddenClass)
          ));
      }
    }));
  const S = () => {
